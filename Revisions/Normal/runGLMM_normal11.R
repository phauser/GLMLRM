...
Rcpp::sourceCpp("~/Project3/Code/LLRM_noBlock.cpp")
...
for(g in 1:G){
  ...
  mod = GLRR(x11, Y, "SS", "no", Q=0.05, r=2*r0, q=q0, nBurnin=1000, nCollect=5000)
...
# save results
save(res, RES, file="/nas/longleaf/home/phauser/Project3/Sim/Revisions/Normal/normal_11.Rdata")
