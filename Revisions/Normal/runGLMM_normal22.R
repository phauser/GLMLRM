...
for(g in 1:G){
  ...
  # run the model
  mod = GLMLRM(x21, Y, "SS", d1=d1, d2=d2, r1=r0, r2=r0, q=q0, nBurnin=1000, nCollect=5000)
...
# save results
save(res, RES, file="/nas/longleaf/home/phauser/Project3/Sim/Revisions/Normal/normal_22.Rdata")
