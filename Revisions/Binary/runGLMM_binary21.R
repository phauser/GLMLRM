...
for(g in 1:G){
  ...
  mod = GLMLRM("SS", x2, Y, r=2*r0, q=q0, 
               epsb=4, epsU=.3, epsV=.5,  epsD=.1, epsL=.4, epsC=.4,
...
# save results
name = paste0("binary_21_", ind)
assign(name, RES)
save(res, RES, file=paste0("/nas/longleaf/home/phauser/Project3/Sim/Revisions/", name, ".Rdata"))
