...
for(g in 1:G){
  ...
  mod = GLMLRM2("SS", x2, Y, d1=d1, d2=d2, r1=r0, r2=r0, q=q0, 
...
# save results
name = paste0("binary_22_", ind)
assign(name, RES)
save(res, RES, file=paste0("/nas/longleaf/home/phauser/Project3/Sim/Revisions/Binary22/", name, ".Rdata"))
